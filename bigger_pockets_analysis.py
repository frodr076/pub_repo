# -*- coding: utf-8 -*-
"""
Created on Thu Feb 23 10:29:42 2023
...
def get_soup(html):
    ...
    #resp.encoding looks for encoded headers and parses content type to lower
    http_encoding = resp.encoding if 'charset' in resp.headers.get('content-type', '').lower() else None
    #finds contents of encoded header
...
def get_links(soup):
    ...
    http_link_list = [] 
    #'a' and href=True indicates a link in the web page
...
filteredlst = punctuation_stop(all_text[0:])
...
mask_logo = np.array(Image.open("C:/Users/frodr/Desktop/Python/Python_Scripts/bigger_pockets_analysis/Bigger_Pockets_Logo4.png"))
